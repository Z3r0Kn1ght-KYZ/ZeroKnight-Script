...
install_falcon_proxy() {
    clear; show_banner
    echo -e "${C_BOLD}${C_PURPLE}--- 🕸️ Installing Falcon Proxy (Websockets/Socks) ---${C_RESET}"
...
show_banner() {
    ...
    clear
    echo
    echo -e "${C_TITLE}❖ ── 🕸️ ${C_BOLD}Z3r0Kn1ght Script v3.4.0 (ActiveLimiter)${C_RESET}${C_TITLE} 🕸️ ── ❖${C_RESET}"
    echo
    echo -e "${C_DIM}    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~${C_RESET}"
...
protocol_menu() {
    while true; do
        ...
        echo -e "     ${C_CHOICE}9)${C_RESET} 🕸️ Install Falcon Proxy (Select Version) ${falconproxy_ports} $falconproxy_status"
